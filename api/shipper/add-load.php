...
class ShipperAddLoad extends LoadBoard
{
    public function AddLoad($arr=array()){
        ...
        if(empty($token)){
            ...
            $shipper_email = isset($arr['shipper_email']) ? trim($arr['shipper_email']) : '';
            $shipper_phone = isset($arr['shipper_phone']) ? trim($arr['shipper_phone']) : '';
            ...
            $phonecheck=parent::PhoneNoCheck($shipper_phone);
            ...
            if(empty($user_id)){
                ...
                $shipper_check_id = parent::shipper_check($user_id);
