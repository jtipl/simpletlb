		...
		$aVars=array("status"=>0,"msg"=>"Invalid user id");
			...
			if(!empty($data)){
				foreach ($data as $key => $value) {
					$sel = $Global->db->prepare("SELECT status as favorite_status FROM favorite WHERE shipper_id=:shipper_id AND trucker_id=:trucker_id AND favorite_type='trucker_favorite' ");
