...
WHERE 
l.user_id=:user_id AND  l.pickup_date > CURRENT_DATE 
AND 
...
$query->execute(array("origin"=>$sorigin,"destination"=>$sdestination,"loadid"=>$sloadid,"weight"=>$sloadweight,"height"=>$sloadheight,"length"=>$sloadlength,"price"=>$sprice,"user_id"=>$user_id));
