...
phptopdf_html($html,'', '../../sample-pdf/current_loads_pdf.pdf');
  


$filename = "current_loads_pdf.pdf";


?>
<script type="text/javascript">
	window.location.href="<?php echo SITEURL ?>sample-pdf/current_loads_pdf.pdf";
</script>