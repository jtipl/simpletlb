...
$user_type = isset($_GET['t']) ? $Global->decode($_GET['t']): '';
...
<!-- After Signup message   -->
 ...
 <div class="alert alert-successn text-center my-4  p-6 animated bounceInDown  " role="alert"> 
 <div class="avatar avatar-xxl bg-white animated headShake delay-1s">
  ...
  <h2 class="display-4 my-4  " >Congratulations!</h2>				
				<h3>You’ve successfully created your account as <?php echo ucfirst($user_type)?> !</h3>
				<!-- <hr class="my-4" > -->
				<!-- <h4 class="text-dark " ><i class=" fa fa-paper-plane-o  mr-2" ></i> A verification mail has been sent to your email account</h4> -->
				<div class="d-flex justify-content-center " >
				<!-- <p class="text-dark col-md-10">Please check the mail to activate your LoadBoard account.</p> -->

			</div>
                              <a href="<?php echo SITEURL; ?>app/signin"  class="btn btn-primary">Sign In</a>
