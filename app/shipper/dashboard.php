...
<div class="card dinfo">
 ...
 <h2 class="page-title">
  ...
  <!--<i class="icon-Loads-InProgress"></i> <i class="fa fa-exchange  "></i>--> Loads In Progress</h2>  
         ...
         <div class="col-md-4 graph">                
                ...
                <div class="col-sm-12">
                    <div class="card dinfo">                     
                      <div class="card-body pl-4 pt-0 line">
                        <h2 class="page-title dashboard-icon">
                        <i class="icon-MissedLoads"></i> Missed Loads
                      </h2>
<!--             <div id="chart-pie" style="height: 12rem;"></div> --> 
        <div id="pie_wait"></div>
          <div class="exp"></div>
          ...
          <div class="col-lg-6">
                <div class="card dinfo">
                 <div class="card-header">
                    <h1 class="page-title"> 
                      <!--<i class=" fe fe-truck "></i>-->
                      <i class="icon-LoadListing"></i>&nbsp; Recent Loads&nbsp;</h1>
  ...
  <div class="col-lg-6">
                <div class="card dinfo">
                 <div class="card-header">
                    <h1 class="page-title"> 
                      <!--<i class="fe fe-box  "></i>-->
                      <i class="icon-heading-AwaitingApprov"></i>&nbsp; Awaiting Approval&nbsp;
                    </h1>
...
<!--   Expired Loads comment by jay // 
 ...
 <script>
      ...
      $( document ).ready(function() {
         $.ajax({
              type:'POST',
              url:LoadBoard.API+'shipper/dashboard',
              dataType: 'json',
              async:false,
              headers: {
