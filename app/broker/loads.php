    ...
    <div class="lb-tabs">
      <nav>
        <div class="nav lb-nav-tabss sm" id="nav-tab" role="tablist">
           <a class="nav-item  nav-item-broker nav-link active" id="nav-trucker-tab" data-toggle="tab" href="#nav-trucker" role="tab" aria-controls="nav-trucker" aria-selected="false"> <!--<i class="fe fe-truck mr-2" ></i>-->
           <i class="icon-LoadListing"></i> &nbsp; Open Loads
            ...
            <span class="tool toottip" style="font-weight: normal;" data-tip="The list of newly added loads available for truckers to confirm" tabindex="1" ><i class="fa fa-question-circle-o"></i></span>
                 ...
                 <a class="nav-item nav-item-broker nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"> 
                  <!--<i class="fa fa-warning mr-2" ></i>--> <i class="icon-ExpiredLoads"></i> &nbsp; Expiring Loads
 &nbsp; &nbsp;
          ...
          <a class="nav-item nav-item-broker nav-link " id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"> 
            <!--<i class=" fe fe-rotate-ccw mr-2" ></i>--><i class="icon-AwaitingApproval"></i> &nbsp; Awaiting Approval
             &nbsp; &nbsp;
           ...
           <a class="nav-item  nav-item-broker nav-link " id="nav-ready" data-toggle="tab" href="#nav-ready" role="tab" aria-controls="nav-ready" aria-selected="true"> 
...
$(document).ready(function() {
        ...
        */
        ...
        if (total_count != 0) {
            ...
            if (export_page == "1") {
                ...
                var length = '10';
                var href = LoadBoard.API + "broker/download-excel-current-view-loads?token=" + token + "&operation=" + tabsid + "&user_id=" + user_id + "&start=" + start + "&length=" + length;
                window.location.href = href;
            } else if (export_page == "2") {
                var href = LoadBoard.API + "broker/download-excel-all-loads?token=" + token + "&operation=" + tabsid + "&length=all&user_id=" + user_id;
                window.location.href = href;
            }
        } else {
            //alert("hi");
    ...
    table = $('.viewloads').DataTable({
        ...
        /* "ajax": {
           url:LoadBoard.API+'broker/view-loads?user_id='+LoadBoard.userid+'&operation='+common_operation,
    ...
    $(document).on("click", "#nav-trucker-tab", function() {
        ...
        table.ajax.url(LoadBoard.API + "broker/view-loads").load();
    });
...
*/
    ...
    $(document).on("click", ".nav-item-broker", function() {
...
function searchbarhide(common_loadid = "") {
    ...
    $.ajax({
        type: 'post',
        url: LoadBoard.API + 'broker/approve-loads-count',
        dataType: "json",
