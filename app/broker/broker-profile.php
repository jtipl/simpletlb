...
<div class="lb-tabs">
  ...
  <div class="tab-content animated  fadeIn" id="nav-tabContent">
    <div class="tab-pane fade  active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
          <form id="broker_profile" method="post" action="">
       ...
       <div class="row">
          ...
          <div class="col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Name" value="" name="broker_name" id="broker_name">    
              </div>
          </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
          ...
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              ...
              <input type="email" class="form-control" placeholder="Email" value="" name="broker_email" id="broker_email">
            </div>
          </div>
          <div class="col-sm-6 col-md-6">
              <div class="form-group">
                      <label class="form-label">Phone</label>
                  <input type="text" name="broker_phone" id="broker_phone" value="" placeholder="Phone" class="form-control" >          
             </div>
          </div> 
          <div class="col-sm-6 col-md-6">
             <div class="form-group">
                  <label class="form-label">Address</label>
               <textarea rows="1" class="form-control" name="broker_addr" id="broker_addr" placeholder="Business Address"></textarea>
              </div>
          </div> 
          <div class="col-sm-6 col-md-6">
              <div class="form-group">
...
*/
 ...
 $("#broker_phone").focusout(function(){
       ...
       jQuery.validator.addMethod("validatePhone", function (txtPhone) {
          ...
          jQuery.validator.addMethod("zero_validate", function (inputtxt) {
            ...
            $("#broker_profile").validate({
                  ...
                  var data=$('#broker_profile').serialize();
  ...
  var creditcard= $("#addcredit").validate({
     ...
     $("#broker_phone,#pay_phone").keypress(function(e){
      ...
      $('#broker_phone,#pay_phone').on('input', function (e) {
    ...
    $("#broker_email").attr("readonly","readonly");
      ...
      $('#zipcode').on("focusout",function(e){
         ...
         getBrokerProfile(LoadBoard.userid);
...
function getBrokerProfile(user_id){
 //alert(LoadBoard.API+'broker-get-profile');
  $.ajax({
      type: 'post',
     ...
     // data:{user_id:LoadBoard.userid,token:LoadBoard.token},
      ...
      success: function (result) { 
          if(result.status==1){
              ...
              $("#broker_addr").val(address1+' '+address2);
...
function broker_profile(data){
 ...
 var Url;
  $.ajax({
      type: 'post',
      url: LoadBoard.API+'broker/update-profile',
      dataType: "json",
...
function addcreditcard(){
   ...
   $.ajax({
      type: 'post',
      url: LoadBoard.API+'broker/payment',
      dataType: "json",
      headers: {
             Authorization: "Bearer "+LoadBoard.token
          },
...
function payment_methods(){
   ...
   $.ajax({
        type:'POST',
        url:LoadBoard.API+'broker/payment-methods',
        dataType: 'json',
        async:false,
        headers: {
           Authorization: "Bearer "+LoadBoard.token
