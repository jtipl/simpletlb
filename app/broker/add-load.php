                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" id="broker_name" name="broker_name" class="form-control" placeholder="Contact Name">
                        ...
                        <div class="col-sm-4 col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" id="broker_email" name="broker_email" class="form-control" placeholder="Contact Email address">
                        ...
                        <div class="col-sm-4 col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" id="broker_phone" name="broker_phone" class="form-control" placeholder="Contact Phone number">
