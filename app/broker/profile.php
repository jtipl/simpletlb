...
$Global->Header("SimpleTLB - Broker Profile");
 ?>
    ...
    <form class="card animated bounceInDown" id="add_profile" role="form"  method="post" autocomplete="off">
     ...
     <div class="alert alert-successn text-center my-7  p-6 animated bounceInDown profile_success" role="alert"> 
      <div class="avatar avatar-xxl bg-white">
        ...
        <a href="<?php echo SITEURL; ?>app/broker/add-load" id="goto" class="btn btn-primary">Add Loads</a>
    </div> 
...
*/
        ...
        /*$('#goto').click(function(){
           window.location.href= LoadBoard.APP+'broker/add-load';
         // window.location.href = LoadBoard.API+'broker/add-load';
        });*/
      ...
      $('#phone').on('input', function (e) {
       ...
       function add_profile(data){
         ...
         $.ajax({
            type: 'post',
            url: LoadBoard.API+'broker/profile',
            dataType: "json",
