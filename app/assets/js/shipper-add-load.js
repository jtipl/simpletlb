...
function last_add_load(){
   $.ajax({
      type: 'post',
      url: LoadBoard.API+'shipper/last-add-load',
      dataType: "json",
            headers: {
       ...
       success:function(result){
          if(result.status==1){
            ...
            //$("#viewloads_list").show();
            $("#openloads").show();
            //opentable.ajax.url(LoadBoard.API + 'shipper/view-loads').load();
          }
       }
    });
}
   ...
   $("#openloads").hide();
	...
	$('#getdetail').click(function(){
     ...
     // data:{user_id:LoadBoard.userid,token:LoadBoard.token},
      ...
      success: function (result) { 
          if(result.status==1){
              $("label#shipper_name-error").css('display','none');
              $("label#shipper_email-error").css('display','none');
              $("label#shipper_phone-error").css('display','none');
...
jQuery.validator.addMethod("destinationcityvalid", function (inputtxt) {
  ...
  jQuery.validator.addMethod("name_valid", function (inputtxt) {
    ...
    $("#addformload").validate({
                ...
                submitHandler: function() {
                   ...
                   // $("#deliverydate_disp").html(delivery_date);
                    ...
                    $("#cont_name").html(jsUcfirst($("#shipper_name").val()));
                  //  $("#cont__busi_name").html($("#business_name").val());
                    $("#cont_email").html($("#shipper_email").val());
                    $("#cont_ph").html($("#shipper_phone").val());
   ...
   $("#shipper_phone").keypress(function(e){
        var regex = new RegExp(/^[0-9]+$/);
        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
        if (regex.test(str)) {
            return true;
      ...
      $('#shipper_phone').on('input', function (e) {
...
function addloadcheck(data=""){
   ...
   $.ajax({
      type: 'post',
      url: LoadBoard.API+'shipper/add-load',
      dataType: "json",
      headers: {
          Authorization: "Bearer "+LoadBoard.token
            },
        ...
        if(result.status==1){
          ...
          if(result.msg == 'Please enter the Origin Latitude' || 
            ...
            result.msg == 'Invalid address, please provide a valid destination city'){
              ...
              $("#delivery_date").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#delivery_date-error").html(result.msg).hide();
              $("#shipper_name").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_name-error").html(result.msg).hide();
              $("#shipper_email").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_email-error").html(result.msg).hide();
              $("#shipper_phone").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_phone-error").html(result.msg).hide();
              ...
              $("#shipper_name-error").html(result.msg).show();
              $("#shipper_email").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_email-error").html(result.msg).hide();
              $("#shipper_phone").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_phone-error").html(result.msg).hide();
              ...
              $("#shipper_email").css("border","1px solid red");
              $("#shipper_email-error").html(result.msg).show();
              $("#shipper_name").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_name-error").html(result.msg).hide();
              $("#shipper_phone").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_phone-error").html(result.msg).hide();
              ...
              $("#shipper_phone").css("border","1px solid red");
              $("#shipper_phone-error").html(result.msg).show();
              $("#shipper_name").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_name-error").html(result.msg).hide();
              $("#shipper_email").css("border","1px solid rgba(0, 40, 100, 0.20 )");
              $("#shipper_email-error").html(result.msg).hide();
