function CardJs(elem) {
    ...
    this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "Visa")
    ...
    this.elem.find(".card-number-wrapper .card-type-icon").attr("class", "card-type-icon show master-card")
      this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "Mastercard")
   ...
   this.elem.find(".card-number-wrapper .card-type-icon").attr("class", "card-type-icon show american-express")
    this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "AMEX")
    ...
    this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "Discover")
    ...
    this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "Diners")
    ...
    this.elem.find(".card-number-wrapper .card-type-icon").attr("id", "JCB")
    ...
    this.expiryMonthInput = CardJs.detachOrCreateElement(this.elem, ".expiry-month", "<input class='expiry-month' name='expiry_month' />")
}, CardJs.prototype.initExpiryYearInput = function() {
    this.expiryYearInput = CardJs.detachOrCreateElement(this.elem, ".expiry-year", "<input class='expiry-year' name='expiry_year'/>")
}, CardJs.prototype.initCvcInput = function() {
    this.cvcInput = CardJs.detachOrCreateElement(this.elem, ".cvc", "<input class='cvc'  />"),
  CardJs.elementHasAttribute(this.cvcInput, "placeholder") || this.cvcInput.attr("placeholder", "CVV"), this.cvcInput.attr("type", "tel"), this.cvcInput.attr("maxlength", CardJs.CVC_MASK_3.length), this.cvcInput.attr("x-autocompletetype", "cc-csc"), this.cvcInput.attr("autocompletetype", "cc-csc"), this.cvcInput.attr("autocorrect", "off"), this.cvcInput.attr("spellcheck", "off"), this.cvcInput.attr("autocapitalize", "off")
    var $this = this;
    ...
    this.stripe && this.cardNumberInput.attr("data-stripe", "number"), this.elem.append("<div class='form-group'><label class='form-label'>Card Number</label><div class='card-number-wrapper'></div></div>");
    ...
    if (this.captureName) {
        this.elem.append("<div class='form-group'><label class='form-label'>Name On Card</label><div class='name-wrapper'></div></div>");
    ...
    this.elem.append("<div class='form-group postcredit'><label class='form-label'>Expiry Date</label><div class='expiry-container'><div class='expiry-wrapper'></div></div></div>");
    ...
    this.stripe && this.cvcInput.attr("data-stripe", "cvc"), this.elem.append("<div class='form-group postcredit'><label class='form-label'>CVV</label><div class='cvc-container'><div class='cvc-wrapper'></div></div></div>");
