...
<!-- After Signup message   -->
 ...
 <div class="avatar avatar-xxl bg-white animated headShake delay-1s">
  ...
  <h2 class="display-4 my-4  " >Oops !</h2>               
                ...
                <p class="text-dark col-md-10">You have been logged out from SimpleTLB now either your session is time out or a new login activity is carried out from another device/browser </p>
                 
            </div>
             <a href="<?php echo SITEURL."app/logout/"; ?>" style="display:inline-block;width:200px;background-color:#467fcf;border-radius:3px;color:#ffffff;font-size:15px;line-height:45px;text-align:center;text-decoration:none;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;box-sizing:border-box">GO TO HOME</a>
</div>
